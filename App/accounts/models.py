...
class EmailStatus(models.Model):
    """Track email sending status for users"""
    EMAIL_TYPES = [
    ...
    user = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='email_statuses')
    ...
    def __str__(self):
        return f"{self.user.email} - {self.get_email_type_display()} ({self.status})"
